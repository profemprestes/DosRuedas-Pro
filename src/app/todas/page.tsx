...
export default function MasterDashboard() {
  ...
  const renderPageWrapper = (pageNum: number, ContentV1: React.ElementType, ContentV2: React.ElementType) => {
    return (
      <div id={`page-wrapper-${pageNum}`} key={pageNum} className="w-full flex flex-col pt-24 pb-12 items-center">
        ...
        {viewMode === 'ab' && (
          <div className="w-full max-w-[1920px] mx-auto px-4 grid grid-cols-1 xl:grid-cols-2 gap-8 lg:gap-16 justify-items-center">
            {/* Left Column - V1 */}
            <div className="flex flex-col items-center w-full overflow-hidden">
               ...
               <div className="transform origin-top scale-[0.5] sm:scale-[0.7] lg:scale-[0.8] xl:scale-[0.85] 2xl:scale-100 transition-transform w-full flex justify-center">
  ...
  const pages = [
    { num: 1, v1: Pagina1V1, v2: Pagina1V2 },
    { num: 2, v1: Pagina2V1, v2: Pagina2V2 },
    { num: 3, v1: Pagina3V1, v2: Pagina3V2 },
    { num: 4, v1: Pagina4V1, v2: Pagina4V2 },
    { num: 5, v1: Pagina5V1, v2: Pagina5V2 },
    { num: 6, v1: Pagina6V1, v2: Pagina6V2 },
    { num: 7, v1: Pagina7V1, v2: Pagina7V2 },
    { num: 8, v1: Pagina8V1, v2: Pagina8V2 },
    { num: 9, v1: Pagina9V1, v2: Pagina9V2 },
    { num: 10, v1: Pagina10V1, v2: Pagina10V2 },
    { num: 11, v1: Pagina11V1, v2: Pagina11V2 },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] font-body text-white relative">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <div className="flex bg-black/50 p-1 rounded-lg border border-white/5 shadow-inner">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-headline tracking-wide transition-all ${
                  viewMode === 'ab'
                    ? 'bg-gradient-to-r from-[#2563eb]/80 to-[#fbc107]/80 text-white shadow-lg border border-white/20'
                    : 'text-white/60 hover:text-white hover:bg-white/5'
                }`}
              >
                COMPARACIÓN A/B
      ...
      <main className="relative z-10 pt-20">
        {pages.map((page) => renderPageWrapper(page.num, page.v1, page.v2))}
      </main>
