        ...
        <main className="flex-1 flex flex-col justify-center mt-2 mb-2 gap-2 max-h-full">
              ...
              <table className="w-full text-left border-collapse">
                  <thead>
                      <tr className="border-b border-white/10 bg-black/20">
                          <th className="px-4 py-2 text-[10px] font-bold text-accent tracking-widest uppercase">Nivel Comercial</th>
                          <th className="px-4 py-2 text-[10px] font-bold text-accent tracking-widest uppercase text-center">Volumen Mensual</th>
                          <th className="px-4 py-2 text-[10px] font-bold text-accent tracking-widest uppercase text-right">Valor x Envío (Plano)</th>
                      </tr>
                  </thead>
                  <tbody className="text-white font-medium">
                      <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                          <td className="px-4 py-2 uppercase text-[10px]">Inicial</td>
                          <td className="px-4 py-2 text-center text-gray-300 text-[10px]">1 a 199 envíos</td>
                          <td className="px-4 py-2 text-right text-lg font-bold text-accent tracking-tighter">$3.800</td>
                      </tr>
                      <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                          <td className="px-4 py-2 uppercase text-[10px]">Pro</td>
                          <td className="px-4 py-2 text-center text-gray-300 text-[10px]">200 a 1.199 envíos</td>
                      ...
                      <tr className="border-b border-white/5 hover:bg-white/5 transition-colors bg-white/5">
                          <td className="px-4 py-2 uppercase text-accent text-[10px]">Elite</td>
                          <td className="px-4 py-2 text-center text-gray-300 text-[10px]">1.200 a 1.999 envíos</td>
                          <td className="px-4 py-2 text-right text-lg font-bold text-accent tracking-tighter">$3.200</td>
                      </tr>
                      <tr className="hover:bg-white/5 transition-colors">
                          <td className="px-4 py-2 uppercase text-[10px]">Partner</td>
                          <td className="px-4 py-2 text-center text-gray-300 text-[10px]">+2.000 envíos</td>
          ...
          <div className="bg-emerald-500 text-slate-900 rounded-2xl p-4 mb-4 relative overflow-hidden shadow-lg border border-emerald-400/50">
              ...
              <div className="relative z-10 text-center">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-3">
                      <p className="font-semibold text-slate-800 leading-tight max-w-lg text-[10px]">
          ...
          <div className="grid grid-cols-2 gap-4 mt-auto">
              ...
              <div className="bg-black/20 border border-white/10 rounded-xl p-4">
                  <h4 className="text-[10px] font-black font-headline uppercase text-accent mb-2 tracking-widest border-b border-white/10 pb-2">Dinámica de Servicio</h4>
              ...
              {/* Excepciones */}
              <div className="bg-black/20 border border-white/10 rounded-xl p-4">
                  <h4 className="text-[10px] font-black font-headline uppercase text-accent mb-2 tracking-widest border-b border-white/10 pb-2">Excepciones y Costos</h4>
                  <ul className="space-y-2 text-[10px] font-medium">
                      <li className="flex items-start gap-2">
                          <span className="text-accent mt-0.5">•</span>
